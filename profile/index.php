...
if ( isset($_SESSION["email"]) ) {
	...
	$occupation = $profile->gimme("occupation", $email);
	$about = $profile->gimme("about", $email);
	$summary = $profile->gimme("summary", $email);
	$currentprojects = $profile->gimme("currentprojects", $email);
}
